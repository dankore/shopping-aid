!(function (e) {
  ...
  function (e, t, n) {
      ...
      i = (function () {
        function e() {
          !(function (e, t) {
            ...
            (this.titleBeforeSave = document.querySelector(
              "#title-before-save"
            )),
          ...
          (n = [
            {
              ...
              value: function () {
                var e = this;
                this.mainWrapper.addEventListener("click", function (t) {
                  t.target &&
                    t.target.classList.contains("checkbox-select-item") &&
                    e.handleCheckBoxClick(t),
                    t.target &&
                      "category-title" == t.target.id &&
                      e.handleOpenClose(t),
                    t.target &&
                      "items-counter" == t.target.id &&
                      e.handleOpenCloseForSpanElem(t),
                    t.target && "submit-btn" == t.target.id && e.handleSubmit(),
                    t.target &&
                      "delete-item" == t.target.id &&
                      e.handleDeleteItem(t),
                    t.target &&
                      "copy-text-btn" == t.target.id &&
                      e.handleCopyText(),
                    t.target &&
                      "increment-btn" == t.target.id &&
                      e.handleCounterIncreaseDecrease(t),
                    t.target &&
                      "decrement-btn" == t.target.id &&
                      e.handleCounterIncreaseDecrease(t);
                });
              },
            },
            {
              ...
              value: function () {
                this.copyTextArea.focus(),
                  ...
                  this.copyTextArea.setSelectionRange(0, 99999);
                try {
                  var e = document.execCommand("copy");
                  alert(e ? "Copied" : "Nothing to copy");
                } catch (e) {
            ...
            },
            {
              key: "handleOpenClose",
              value: function (e) {
                "none" == e.target.parentElement.children[1].style.display
                  ? (e.target.parentElement.children[1].style.display = "block")
                  : (e.target.parentElement.children[1].style.display = "none");
              },
            },
            {
              key: "handleOpenCloseForSpanElem",
              value: function (e) {
                "none" ==
              ...
              value: function () {
                ...
                0 != this.arr.length &&
                  o
                    ...
                    .then(function (t) {
                      e.listSection.insertAdjacentHTML(
                        "afterbegin",
                        e.html(t.data)
                      ),
                        (e.titleBeforeSave.value = ""),
                        (e.viewerContainer.innerHTML = ""),
                        e.titleBeforeSave.focus(),
                        e.handleStatNumShopListCreated(),
                        (e.arr = []);
                    })
                    .catch(function (e) {
                      alert(e);
            ...
            {
              key: "handleStatNumShopListCreated",
              value: function () {
              ...
              value: function (e) {
                return (
                  '<div class="mb-5 rounded">\n            <div class="flex justify-between background-color rounded-tr rounded-tl text-white text-xl sm:text-base cursor-pointer uppercase">\n              <h2\n                id="list-title"\n                class="w-full p-2"\n                style="overflow-wrap: break-word; min-width: 0px;"\n              >\n                '
                    .concat(
                      e[0].title,
                      '\n                <span id="items-counter" class="inline-block ml-4 rounded-full px-2 text-gray-800 bg-white">'
                    )
                    .concat(
                      e[0].items.length,
                      '</span> items\n              </h2>\n              <button id="delete-list" data-id="'
                    )
                    .concat(
                      e[0]._id,
                  ...
                  e[0].items
                    .map(function (t) {
                      return '<div\n              class="flex justify-between border border-gray-200 bg-white px-2 py-1"\n            >\n              <li>'
                        .concat(
                          t,
                          '</li>\n              <button id="delete-a-shopping-lists-item"  data-id="'
                        )
                        .concat(e[0]._id, '" data-item="')
                        .concat(
                          t,
                          '" class="text-red-600">Done</button>\n            </div>'
                        );
                    })
                    .join("") +
                  "\n            </ul>\n        </div>\n    "
            ...
            {
              key: "handleCounterIncreaseDecrease",
              value: function (e) {
                ("" == e.target.parentElement.children[1].innerText ||
                  ...
                  +e.target.parentElement.children[1].innerText >= 2 &&
                    (e.target.parentElement.children[1].innerText =
                      +e.target.parentElement.children[1].innerText +
            ...
            },
            {
              ...
              value: function (e) {
                var t = e.target.getAttribute("data-cat")
                ...
                e.srcElement.checked
                  ? !this.arr.includes(e.target.value) && this.arr.push(t)
                  : this.arr.splice(this.arr.indexOf(t), 1);
                for (var n = "", r = 0; r < this.arr.length; r++)
                  n +=
                    0 == n.length
                      ? "".concat(this.arr[r])
                      : ", ".concat(this.arr[r]);
                (this.viewerContainer.innerHTML = n),
                  (this.copyTextArea.innerText = this.arr);
              },
            },
          ]) && r(t.prototype, n),
          i && r(t, i),
      ...
      c = (function () {
        function e() {
          !(function (e, t) {
            ...
            (this.openAddNewItemModal = document.querySelector(
              "#open-add-modal"
            )),
            ...
            (this.noItemContainer = document.querySelector(
              "#no-item-container"
            )),
            (this.arr = []),
            this.events();
          ...
          (n = [
            {
              ...
              value: function () {
                var e = this;
                Array.prototype.forEach.call(this.checkboxes, function (t) {
                  t.addEventListener("click", function (t) {
                    return e.handleCheckboxClick(t);
                  });
                }),
                  this.addNewItemBtn.addEventListener("click", function () {
                    return e.handleSubmit();
                  }),
                  this.openAddNewItemModal.addEventListener("click", function (
                    t
                  ) {
                    return e.handleOpenModal();
                  }),
                  this.closeAddNewItemModal.addEventListener("click", function (
                    t
                  ) {
                    return e.handleCloseModal();
                  });
              },
            },
            {
            ...
            },
            {
              key: "handleOpenModal",
              value: function () {
                "none" == this.addNewItemModal.style.display &&
            ...
            },
            {
              ...
              value: function (e) {
                for (var t = 0; t < e.categories.length; t++)
                  switch (e.categories[t].toLowerCase()) {
                    case "fruits":
            ...
            },
            {
              ...
              value: function (e) {
                return '\n      <div class="flex justify-between my-1">\n        <div class="flex">\n          <div id="counter-container" class="flex">\n            <button id="decrement-btn" data-dec="-1" class="value-button">\n              -\n            </button>\n            <div id="counter" contenteditable="true">1</div>\n            <button id="increment-btn" data-inc="1" class="value-button">\n              +\n            </button>\n            </div>\n            <label class="cursor-pointer ml-2" for="'
                  ...
                  .concat(e.item, '"\n              data-cat="')
                  .concat(
                    "Frozen" == e.cat || "Fresh" == e.cat ? e.cat : "",
                    '"\n            />\n            '
                  )
                  .concat(
                    e.item,
          ...
          (n = [
            {
              ...
              value: function () {
                var e = this;
                this.listSectionWrapper.addEventListener("click", function (t) {
                  t.target &&
                    "list-title" == t.target.id &&
                    e.handleCloseOpen(t),
                    t.target &&
                      "delete-list" == t.target.id &&
                      e.handleDeleteShoppingList(t),
                    t.target &&
                      "delete-a-shopping-lists-item" == t.target.id &&
                      e.handleDeleteShoppingListItem(t);
                });
              },
            },
            {
              key: "handleDeleteShoppingListItem",
              value: function (e) {
                var t =
            ...
            {
              key: "handleDeleteShoppingList",
              value: function (e) {
                confirm("Delete Shopping List?") &&
                  (l.post("/delete-shopping-list", {
                    id: e.target.getAttribute("data-id"),
                  }),
    ...
    document.querySelector(".checkbox-select-item") && new i(),
      document.querySelector(".checkbox-new-item") && new c(),
      document.querySelector("#list-section") && new d();
  },
]);
